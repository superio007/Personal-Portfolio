...
function Footer() {
  return (
    <>
      <footer>
        <div id='First'>
            <p>Copyright<i class="fa-regular fa-copyright fa-2xs"></i>2023 Created By Kiran Dhoke</p>
        </div>
        <div id='second'>
        ...
        <a href="#" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-square-facebook fa-lg" ></i></a>
        </div>
    </footer>
    </>
  )
